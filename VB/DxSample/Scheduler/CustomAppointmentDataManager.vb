...
Namespace DxSample.Scheduler
    Public Class CustomAppointmentDataManager
        ...
        Protected Overrides Sub BeginInsertNewObjectRow(ByVal obj As Appointment)
            Dim appointment As CustomAppointment = DirectCast(obj, CustomAppointment)
            If appointment.ObjectForInsert Is Nothing Then
                MyBase.BeginInsertNewObjectRow(obj)
            Else
                DirectCast(obj, CustomAppointment).SetRowHandleInternal(DataController.GetControllerRow(DataController.ListSource.Add(appointment.ObjectForInsert)))
            End If
        End Sub
